...
import { ArrowLeft, ChevronDown, ChevronRight, Image as ImageIcon, Loader2, MessageSquare, PackageSearch } from "lucide-react";
...
export default function AdminQuoteRequests() {
  ...
  if (!user) return <div className="confirmation-page"><span className="eyebrow">QUOTE INBOX</span><h1>Admin sign-in required.</h1><Link href="/admin/login" className="button button-primary">Sign in to operations</Link></div>;
