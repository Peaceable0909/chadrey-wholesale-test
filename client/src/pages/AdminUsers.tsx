...
export default function AdminUsers() {
  ...
  if (!user) return <div className="confirmation-page"><span className="eyebrow">DIRECTORY / USERS</span><h1>Sign-in required.</h1><Link href="/admin/login" className="button button-primary">Sign in to operations</Link></div>;
  if (user.role !== "admin") return <div className="confirmation-page"><span className="eyebrow">DIRECTORY / USERS</span><h1>Access restricted.</h1><p>Only Chadrey Wholesale administrators can manage user roles.</p><Link href="/dashboard" className="button button-secondary">Back to workspace</Link></div>;
