...
import { ArrowRight, Filter, Heart, Package, Search, Shirt, ShoppingBag, SlidersHorizontal , Menu} from "lucide-react";
...
const categoryIcon = (category: string) => category === "Bags" ? ShoppingBag : category === "Apparel" ? Shirt : Package;
