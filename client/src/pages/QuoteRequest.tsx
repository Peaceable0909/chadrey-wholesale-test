...
export default function QuoteRequest() {
  ...
  if (submittedRef) return <div className="app-shell"><header className="site-header"><Link href="/" className="brand"><span className="brand-mark">C</span><span>CHADREY<small>WHOLESALE</small></span></Link></header><main className="confirmation-page quote-success-page" role="status" aria-live="polite"><div className="success-mark quote-success-mark" aria-hidden="true"><span className="success-ring"/><Check size={27}/></div><span className="eyebrow success-eyebrow">REQUEST RECEIVED</span><h1>Your quote request has been sent.</h1><p>Thank you. We have received your products, preferences, requirements, and any reference material. Our team will review everything and prepare your quotation.</p><div className="success-next-step"><strong>What happens next?</strong><span>We will contact you when your quotation is ready. You can track the request and its status from your workspace.</span></div><div className="reference-card"><span>Request reference</span><strong>{submittedRef}</strong><small>Track it from your workspace.</small></div><div className="hero-actions"><Link href="/dashboard" className="button button-primary">View my quotes <ArrowRight size={16}/></Link><Link href="/products" className="button button-secondary">Browse more products</Link></div></main></div>;
